...
import { rootRouteId, parseRedirect, isRedirect, defaultSerovalPlugins, makeSerovalPlugin, createRawStreamRPCPlugin, invariant, isNotFound, getScriptPreloadAttrs, getStylesheetHref, resolveManifestCssLink, resolveManifestAssetLink, getManifestScriptFormat, createSerializationAdapter, isResolvedRedirect, executeRewriteInput } from "@tanstack/router-core";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Dz86yPwP.js");
...
const manifest = {
  "fbd394cc9fa4af3080fc71bce795b650ae4ce5bc0cb7fdb09c73ce183438bcb8": {
    functionName: "sendContactMessage_createServerFn_handler",
    importer: () => import("./contact.functions-Y1f3_hIn.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CqSi252H.js"),
    import("./start-BLFCCuXq.js"),
